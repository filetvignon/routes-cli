...
module.exports = class Server {
  ...
  async router(req, res) {
    ...
    try {
      ...
      // This will run after any controller or error handler
      // WRites the response into ctx.response, eg.
      /*
      ctx.response = {
        statusCode: Number,
      ...
      */
      ...
      if (body) {
        try {
          ...
          // controllers produced an invalid response, can't transform into json
          statusCode = 502;
          body = JSON.Stringify({
            statusCode,
          ...
          // Common headers for responses with body
          headers = {
            ...headers,
